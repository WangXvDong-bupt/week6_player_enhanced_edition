...
void AudioPlayer::audioSetting()
{
	...
	s_touch.setSampleRate(out_sample_rate); // ���ñ���ʱ�Ĳ�����
	s_touch.setChannels(out_channel_nb); // ���ñ���ʱ��ͨ����
}
...
>>>>>>> e5ff6fa5c30019016b1ac980a9eda9fc97e72c97
	...
	if (ret == 2) {
		...
		if (speed_req) {
			...
			ptsAudioFromSpeed = ptsAudio;			//��¼��ʼ���ٲ���ʱ��pts
		...
		if (isRevSample) {
			...
			//ptsAudio = ptsAudioFromSpeed + (ptsAudio - ptsAudioFromSpeed) * speed_idx;			//���±����µ�pts
...
int AudioPlayer::playByOpenAL(uint64_t* pts_audio)
{
	...
	while (true) {
		...
		/*if (speed_req) {
			//alSourcef(source, AL_PITCH, speed_idx);		//�ı�����
			speed_req = false;
		}*/
